...
const features = [
  {
    ...
    description: 'Connect with experienced mentors to develop skills in Frontend Dev, Backend Dev, DevOps, and more.',
  ...
  },
  {
    ...
    description: 'Explore mentorship opportunities tailored to your career goals and interests.',
  ...
  },
  {
    ...
    description: 'Be part of a community that fosters growth and knowledge exchange.',
  ...
  },
  {
    ...
    description: 'Utilize in-app messaging and notifications to communicate with your mentors and mentees.',
  ...
  },
  {
    ...
    description: 'Set and track your mentorship goals to ensure continuous progress.',
  ...
  return (
    <div className="bg-background py-24 sm:py-32">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-base font-semibold text-primary">Connections with Purpose</h2>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
          {features.map((feature, index) => (
            <Card key={index} className={`overflow-hidden ${feature.gridClass} ${feature.roundedClass}`}>
              <CardContent className="p-0">
                <img alt="" src={feature.image} className={`h-80 w-full object-cover ${feature.imagePosition}`} />
                <div className="p-6">
                  <CardHeader className="p-0">
                    <h3 className="text-sm font-semibold text-primary">{feature.title}</h3>
                    <CardTitle className="mt-2 text-lg font-medium tracking-tight">{feature.subtitle}</CardTitle>
                  </CardHeader>
